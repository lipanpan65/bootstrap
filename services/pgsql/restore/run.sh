#!/usr/bin/env bash
# ============================================================
# services/pgsql/restore/run.sh — PostgreSQL 数据库恢复脚本
#
# 用法:
#   ./services/pgsql/restore/run.sh <backup_file> [选项...]
#   ./services/pgsql/restore/run.sh mydb.dump -H 10.0.0.1 -d mydb --yes
#   ./services/pgsql/restore/run.sh mydb.dump -d mydb_new -j 8 --yes
